        ...
        if (property.hasOwnProperty("langType") && property.langType.hasOwnProperty("proto")) {
            ...
            switch (property.type) {
                ...
                case "string":
                    ...
                    break;
                case "array":
                    type = "repeated " + this.interfaceToClassName(property.items["$ref"].replace("#/primitives/", ""));
                    break;
                case "object":
                    type = name;
                    break;
            ...
            type = this.interfaceToClassName(property["$ref"].replace("#/primitives/", ""));
